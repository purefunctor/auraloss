...
RAW_CM1A2_DAY_1 = annotate(
    [
        "Hellekka",
        (CM1ARatio.THREE, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.TWO, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.SIX, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.SIX, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        "Hanna",
        ...
        (CM1ARatio.THREE, CM1AAttack.FAST, CM1ARelease.FAST),
        (CM1ARatio.FIVE, CM1AAttack.MEDIUM_SLOW, CM1ARelease.SLOW),
        (CM1ARatio.FIVE, CM1AAttack.MEDIUM_SLOW, CM1ARelease.SLOW),
        (CM1ARatio.EIGHT, CM1AAttack.SLOW, CM1ARelease.FAST),
        (CM1ARatio.EIGHT, CM1AAttack.SLOW, CM1ARelease.FAST),
        "Michael",
        (CM1ARatio.EIGHT, CM1AAttack.SLOW, CM1ARelease.FAST),
        (CM1ARatio.EIGHT, CM1AAttack.SLOW, CM1ARelease.FAST),
...
RAW_CM1A1_DAY_1 = annotate(
    [
        "Hellekka",
        None,
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.FIVE, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.FIVE, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        "Hanna",
        ...
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.SIX, CM1AAttack.FAST, CM1ARelease.MEDIUM),
        (CM1ARatio.SIX, CM1AAttack.FAST, CM1ARelease.MEDIUM),
        "Michael",
        (CM1ARatio.SIX, CM1AAttack.FAST, CM1ARelease.MEDIUM),
        (CM1ARatio.SIX, CM1AAttack.FAST, CM1ARelease.MEDIUM),
...
assert len(RAW_CM1A2_DAY_1) == len(RAW_DISTANCES_DAY_1)
assert len(RAW_CM1A1_DAY_1) == len(RAW_DISTANCES_DAY_1)
assert cm1a_is_sane(RAW_CM1A1_DAY_1)
assert cm1a_is_sane(RAW_CM1A2_DAY_1)
...
RAW_CM1A2_DAY_2 = annotate(
    [
        "Siina",
        (CM1ARatio.THREE, CM1AAttack.MEDIUM, CM1ARelease.SLOW),
        (CM1ARatio.THREE, CM1AAttack.MEDIUM, CM1ARelease.SLOW),
        (CM1ARatio.FIVE, CM1AAttack.FAST, CM1ARelease.MEDIUM_SLOW),
        (CM1ARatio.FIVE, CM1AAttack.FAST, CM1ARelease.MEDIUM_SLOW),
        (CM1ARatio.EIGHT, CM1AAttack.FAST, CM1ARelease.FAST),
        (CM1ARatio.EIGHT, CM1AAttack.FAST, CM1ARelease.FAST),
        (CM1ARatio.TWO, CM1AAttack.MEDIUM, CM1ARelease.FAST),
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM),
        "Amanda",
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM),
        (CM1ARatio.FOUR, CM1AAttack.SLOW, CM1ARelease.MEDIUM),
        (CM1ARatio.FOUR, CM1AAttack.SLOW, CM1ARelease.MEDIUM),
        (CM1ARatio.FOUR, CM1AAttack.SLOW, CM1ARelease.MEDIUM),
        (CM1ARatio.SIX, CM1AAttack.SLOW, CM1ARelease.FAST),
        "Eerika",
        (CM1ARatio.SIX, CM1AAttack.SLOW, CM1ARelease.FAST),
        (CM1ARatio.TWO, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM_FAST),
        (CM1ARatio.TWO, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM_FAST),
        ...
        (CM1ARatio.TWO, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM_FAST),
        (CM1ARatio.TWO, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM_FAST),
        (CM1ARatio.THREE, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM_FAST),
        "Severi",
        None,
        None,
        (CM1ARatio.TWO, CM1AAttack.FAST, CM1ARelease.FAST),
        (CM1ARatio.TWO, CM1AAttack.FAST, CM1ARelease.FAST),
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM, CM1ARelease.FAST),
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM, CM1ARelease.FAST),
        "Mirjam",
        None,
    ]
)
RAW_CM1A1_DAY_2 = annotate(
    [
        "Siina",
        (CM1ARatio.TWO, CM1AAttack.MEDIUM, CM1ARelease.FAST),
        (CM1ARatio.TWO, CM1AAttack.MEDIUM, CM1ARelease.FAST),
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM),
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM),
        (CM1ARatio.SIX, CM1AAttack.SLOW, CM1ARelease.SLOW),
        (CM1ARatio.SIX, CM1AAttack.SLOW, CM1ARelease.SLOW),
        (CM1ARatio.EIGHT, CM1AAttack.FAST, CM1ARelease.MEDIUM),
        (CM1ARatio.TWO, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM_SLOW),
        "Amanda",
        (CM1ARatio.TWO, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM_SLOW),
        (CM1ARatio.THREE, CM1AAttack.FAST, CM1ARelease.MEDIUM_FAST),
        (CM1ARatio.THREE, CM1AAttack.FAST, CM1ARelease.MEDIUM_FAST),
        (CM1ARatio.THREE, CM1AAttack.FAST, CM1ARelease.MEDIUM_FAST),
        (CM1ARatio.FIVE, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        "Eerika",
        (CM1ARatio.FIVE, CM1AAttack.MEDIUM, CM1ARelease.MEDIUM),
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_SLOW, CM1ARelease.MEDIUM_SLOW),
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_SLOW, CM1ARelease.MEDIUM_SLOW),
        "Vilja",
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_SLOW, CM1ARelease.MEDIUM_SLOW),
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_SLOW, CM1ARelease.MEDIUM_SLOW),
        (CM1ARatio.THREE, CM1AAttack.FAST, CM1ARelease.MEDIUM),
        "Severi",
        None,
        None,
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_FAST, CM1ARelease.FAST),
        (CM1ARatio.EIGHT, CM1AAttack.MEDIUM_FAST, CM1ARelease.FAST),
        (CM1ARatio.THREE, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM),
        (CM1ARatio.FOUR, CM1AAttack.MEDIUM_FAST, CM1ARelease.MEDIUM),
        "Mirjam",
        None,
    ]
...
assert len(RAW_COMPRESSOR_DAY_2) == len(RAW_DISTANCES_DAY_2)
assert len(RAW_1178_DAY_2) == len(RAW_DISTANCES_DAY_2)
assert len(RAW_CM1A2_DAY_2) == len(RAW_DISTANCES_DAY_2)
assert len(RAW_CM1A1_DAY_2) == len(RAW_DISTANCES_DAY_2)
assert cm1a_is_sane(RAW_CM1A1_DAY_2)
assert cm1a_is_sane(RAW_CM1A2_DAY_2)
