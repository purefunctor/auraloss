...
wandb_logger = WandbLogger(project="eleven78-compressor-unsilenced", log_model="all")
model_checkpoint = ModelCheckpoint(save_top_k=-1, every_n_epochs=1)
trainer = Trainer(max_epochs=40, precision=precision, callbacks=[model_checkpoint], logger=wandb_logger)
